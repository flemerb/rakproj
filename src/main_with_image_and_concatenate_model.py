# this version of main.py also trains the VGG and the concatenate model, which takes much longer and in 
# the case of the concatenate model was still involving error messages
# 
